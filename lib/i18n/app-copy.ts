...
const english = {
  ...
  studio: {
    ...
    passport: {
      ...
      skills: "skills evidenced",
      trailTitle: "Evidence trail",
      noAvailability: "Availability not set",
      research: "Research",
      design: "Design",
      build: "Build",
      publish: "Publish",
    ...
    work: {
      ...
      count: "{n} items",
      countOne: "{n} item",
      empty: "Nothing here yet. Finish a mission and it becomes a case study you can show.",
      noMatch: "No work matches that.",
      clear: "Clear",
      openCase: "Open case study",
      viewSubmission: "View submission",
      openDraft: "Open draft",
      demo: "Demo account",
      noSummary: "No summary written for this mission.",
    },
    resume: {
      title: "Proof-to-Resume Builder",
      intro: "Pick the verified work you want included. Every line is assembled from your own records, shows the mission it came from, and is yours to edit.",
      selected: "{n} selected",
      ...
      empty: "Verified work appears here once a reviewer has confirmed it.",
      draftTitle: "Experience",
      skillsTitle: "Evidenced skills",
      sourceLead: "Source:",
      editHint: "Edit any line. Nothing here was written for you — it is assembled from what was verified.",
      print: "Print or save as PDF",
      printNote: "Opens your browser's print dialog. The file is made on your device and never uploaded.",
      docxNote: "DOCX export is not built yet.",
      noneSelected: "Select at least one verified mission to build a draft.",
      draftHeading: "Your résumé draft",
      openDraft: "Open draft",
      close: "Close",
    },
  },
...
const myanmar: typeof english = {
  ...
  studio: {
    ...
    passport: {
      ...
      completed: "ပြီးစီးသော လုပ်ငန်းများ",
      verified: "လူသား အတည်ပြုပြီး",
      skills: "သက်သေပြထားသော ကျွမ်းကျင်မှု",
      trailTitle: "သက်သေ လမ်းကြောင်း",
      noAvailability: "အလုပ်လက်ခံနိုင်မှု မသတ်မှတ်ရသေးပါ",
      research: "လေ့လာ",
      design: "ဒီဇိုင်း",
      build: "တည်ဆောက်",
      publish: "ထုတ်ဝေ",
    ...
    work: {
      title: "ပြီးစီးသော လက်ရာ",
      search: "သင့်လက်ရာ ရှာမည်",
      all: "အားလုံး",
      ...
      count: "{n} ခု",
      countOne: "{n} ခု",
      empty: "ဘာမှ မရှိသေးပါ။ လုပ်ငန်းတစ်ခု ပြီးမြောက်လျှင် ပြသနိုင်သော လက်ရာဖြစ်လာမည်။",
      noMatch: "ကိုက်ညီသော လက်ရာ မရှိပါ။",
      clear: "ရှင်းမည်",
      openCase: "လက်ရာ အသေးစိတ် ကြည့်မည်",
      viewSubmission: "တင်ပြချက် ကြည့်မည်",
      openDraft: "မူကြမ်း ဖွင့်မည်",
      demo: "နမူနာအကောင့်",
      noSummary: "ဤလုပ်ငန်းအတွက် အကျဉ်းချုပ် မရေးရသေးပါ။",
    },
    resume: {
      title: "သက်သေမှ ကိုယ်ရေးရာဇဝင် တည်ဆောက်ကိရိယာ",
      intro: "ထည့်သွင်းလိုသော အတည်ပြုပြီး လက်ရာကို ရွေးပါ။ စာကြောင်းတိုင်းကို သင့်မှတ်တမ်းများမှ စုစည်းထားပြီး မည်သည့်လုပ်ငန်းမှဖြစ်ကြောင်း ဖော်ပြကာ သင်ကိုယ်တိုင် ပြင်ဆင်နိုင်သည်။",
      selected: "{n} ခု ရွေးထားသည်",
      selectedOne: "{n} ခု ရွေးထားသည်",
      selectAll: "အားလုံး ရွေးမည်",
      clear: "ရှင်းမည်",
      build: "မူကြမ်း တည်ဆောက်မည်",
      rebuild: "မူကြမ်း ပြန်တည်ဆောက်မည်",
      empty: "သုံးသပ်သူက အတည်ပြုပြီးမှ အတည်ပြုထားသော လက်ရာများ ဤနေရာတွင် ပေါ်လာမည်။",
      draftTitle: "အတွေ့အကြုံ",
      skillsTitle: "သက်သေပြထားသော ကျွမ်းကျင်မှုများ",
      sourceLead: "မူရင်း —",
      editHint: "စာကြောင်းတိုင်းကို ပြင်နိုင်သည်။ ဤနေရာတွင် သင့်ကိုယ်စား ရေးပေးထားသည် မရှိပါ — အတည်ပြုထားသည်များမှ စုစည်းထားခြင်းသာ ဖြစ်သည်။",
      print: "ပရင့်ထုတ် သို့မဟုတ် PDF သိမ်းမည်",
      printNote: "သင့် browser ၏ print dialog ကို ဖွင့်သည်။ ဖိုင်ကို သင့်စက်ပေါ်တွင် ဖန်တီးပြီး မည်သည့်နေရာသို့မျှ မတင်ပါ။",
      docxNote: "DOCX ထုတ်ယူမှုကို မတည်ဆောက်ရသေးပါ။",
      noneSelected: "မူကြမ်းတည်ဆောက်ရန် အတည်ပြုပြီး လုပ်ငန်းအနည်းဆုံး တစ်ခု ရွေးပါ။",
      draftHeading: "သင့် ကိုယ်ရေးရာဇဝင် မူကြမ်း",
      openDraft: "မူကြမ်း ဖွင့်ရန်",
      close: "ပိတ်ရန်",
    },
  },
