...
const english = {
  ...
  paths: {
    ...
    alternatives: "Alternatives for you", alternativesTitle: "Only two options, with a reason.", editCompass: "Edit my Career Compass", firstMission: "First mission", choosePath: "Choose this path", onlyAvailable: "Your current path is the only operational option right now. You can still explore upcoming careers below.",
