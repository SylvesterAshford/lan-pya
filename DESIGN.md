...
| 2026-08-17 | **Navy becomes primary; teal becomes the accent** | Founder direction. Navy is the surface family, teal keeps its meaning (us, direction, progress) but is lifted to `#34C98F` because the `#0F6E56` that read well on white is too dark on navy. |
